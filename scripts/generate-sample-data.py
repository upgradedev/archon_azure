...
def gen_attiki():
    ...
    t(c, 2, 9.8, "ARCHON DEMO IKE  |  ΑΦΜ: 800000001")
...
def gen_anthropic():
    ...
    t(c, 2, 6.3, "ARCHON DEMO IKE  |  VAT: EL800000001")
...
def gen_aws():
    ...
    t(c, 2, 5.8, "ARCHON DEMO IKE  |  VAT: EL800000001")
    ln(c, 2, 7, 19, 7)
...
def gen_payroll_register():
    ...
    t(c, 2, 2, "ARCHON DEMO IKE", 14, bold=True)
    t(c, 2, 2.9, "ΑΦΜ: 800000001  |  ΑΜΑΕ: 12345/01/Β/21/001")
...
def gen_bank_confirmation():
    ...
    ln(c, 2, 4, 19, 4)
    t(c, 2, 4.8, "Εταιρεία:  ARCHON DEMO IKE  |  ΑΦΜ: 800000001")
...
def gen_payslip():
    ...
    t(c, 2, 2.9, "ARCHON DEMO IKE  |  ΑΦΜ: 800000001")
    ln(c, 2, 3.8, 19, 3.8)
...
def gen_statement():
    ...
    t(c, 2, 5.3, "Customer: ARCHON DEMO IKE  |  VAT: EL800000001")
